...
import com.example.inventoryapp.viewModel.ArticleViewModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        articleViewModel.getAllArticles().observe(this, articles -> adapter.setArticles(articles));
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        articleViewModel.delete(adapter.getArticleAt(viewHolder.getAdapterPosition()));
        ...
        adapter.setOnItemClickListener(new ArticleAdapter.OnItemClickListener() {
            ...
            public void onItemClick(Article article) {
                ...
                intent.putExtra(ArticleActivity.EXTRA_NAME, article.getName());
                intent.putExtra(ArticleActivity.EXTRA_PRICE, article.getPrice());
                intent.putExtra(ArticleActivity.EXTRA_QUANTITY, article.getQuantity());
                intent.putExtra(ArticleActivity.EXTRA_SUPPLIER, article.getSupplier());
                intent.putExtra(ArticleActivity.EXTRA_IMAGE, article.getImage());
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == ADD_ARTICLE_REQUEST && resultCode == RESULT_OK) {
            String name = data.getStringExtra(ArticleActivity.EXTRA_NAME);
            int price = data.getIntExtra(ArticleActivity.EXTRA_PRICE, 1);
            int quantity = data.getIntExtra(ArticleActivity.EXTRA_QUANTITY, 1);
            String supplier = data.getStringExtra(ArticleActivity.EXTRA_SUPPLIER);
            String image = data.getStringExtra(ArticleActivity.EXTRA_IMAGE);
            ...
            int id = data.getIntExtra(ArticleActivity.EXTRA_ID, -1);
            ...
            case R.id.delete_all_articles:
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast.makeText(MainActivity.this, "All articles deleted", Toast.LENGTH_SHORT).show();
                    }
                });
                builder.setNegativeButton("No", new DialogInterface.OnClickListener() {
                    @Override
